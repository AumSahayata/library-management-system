      ...
      <header className="bg-neutral-900 text-primary-foreground py-4 px-6 flex items-center justify-between">
        ...
        {!loggedIn && (
          <div className="flex items-center gap-4">
            <Link href="/login">
              <Button className="bg-neutral-900 border-solid border-2 border-primary-foreground text-primary-foreground hover:bg-primary-foreground/90 hover:text-neutral-900 focus:ring-primary">
                Sign In
              </Button>
            </Link>
          </div>
        ...
        {!loggedIn && (
          <section className="bg-neutral-900 py-20 px-6 text-primary-foreground">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <p className="text-xl">
                Explore our vast collection of books and find your perfect
                match.
              </p>
              <SearchBar />
            </div>
